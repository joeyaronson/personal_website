...
class Section
{
    ...
    display()
    {
        ...
        for(let i = 0; i < this.num; i++)
        {
            ...
            //vertex(this.x1 + cos(this.a*i)* 50 + i * difx,this.y1+ sin(this.a*i)* 50 +i*dify);
            //ellipse(this.x1 + cos(this.a*i)* 50 + i * difx,this.y1+ sin(this.a*i)* 50 +i*dify,this.size,this.size);
            ...
            //ellipse(this.x1 + i * difx,this.y1+i*dify,this.size,this.size);
        }
        endShape();
